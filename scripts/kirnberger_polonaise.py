...
dice_game.typeset_single_bar('polonaise', 1, '/tmp/test/bar_polonaise_1.ly')
...
composition.typeset('/tmp/test/composition.ly', render_options={'large_page': True, 'comment': 'test'})
