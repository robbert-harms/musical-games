...
dice_game = load_inbuilt_dice_game('kirnberger_menuet_trio')
...
dice_game.typeset_single_bar('menuet', 1, '/tmp/test/bar_menuet_1.ly')
auto_convert_lilypond_file('/tmp/test/bar_menuet_1.ly')
dice_game.typeset_single_bar('trio', 1, '/tmp/test/bar_trio_1.ly')
...
composition.typeset('/tmp/test/composition.ly', render_options={'comment': 'Comment'})
