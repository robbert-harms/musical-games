...
auto_convert_lilypond_file(Path('/tmp/test/overview.ly'))

dice_game.typeset_single_bar('treble', 1, out_file='/tmp/test/bar_treble_1.ly')
auto_convert_lilypond_file(Path('/tmp/test/bar_treble_1.ly'))
dice_game.typeset_single_bar('bass', 1, out_file='/tmp/test/bar_bass_1.ly')
auto_convert_lilypond_file(Path('/tmp/test/bar_bass_1.ly'))
